...
export default function Services() {
  const services = [
    ...
    { title: "Virtual CFO", description: "Turn your financial data into a clear strategic roadmap with our flexible Virtual CFO services. We provide the executive insight you need to scale with confidence and maximize ROI.", icon: BarChart3 },
